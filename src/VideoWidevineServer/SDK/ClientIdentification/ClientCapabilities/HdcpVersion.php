...
namespace VideoWidevineServer\SDK\ClientIdentification\ClientCapabilities;

use UnexpectedValueException;

/**
 * Protobuf type <code>VideoWidevineServer.SDK.ClientIdentification.ClientCapabilities.HdcpVersion</code>
 */
class HdcpVersion
{
    /**
...
class_alias(HdcpVersion::class, \VideoWidevineServer\SDK\ClientIdentification_ClientCapabilities_HdcpVersion::class);
